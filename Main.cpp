...
#include <vector> // contains sequence containers that represent arrays
#include <vulkan/vulkan.h> // contains Vulkan
#include <optional> // for performing a generic check on a struct
#include <set>
#include <algorithm>
#include <limits>
...
private:
	...
	void createGraphicsPipeline()
	{
		...
		if (vkCreatePipelineLayout(device, &pipelineLayoutInfo, nullptr, &pipelineLayout) != 0)
		{
